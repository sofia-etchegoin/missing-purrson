...
| ------ | -------------------------------------       | ---------- | ------------------------------- | ---------------------- |
| GET    | `/api/v1/missingcats`                       | No         | gets a list of missing cats     | an array of cats       |
| GET    | `/api/v1/missingcats/singlecat/:id`         | No         | gets an individual missing cat  | an object              |
| POST   | `/api/v1/missingcats/addcat`                 | Yes        | add a new missing cat           | the newly uploaded cat |
| DELETE | `/api/v1/missingcats/:id`                    | Yes        | delete an existing cat          | nothing (status OK)    |
| PATCH  | `/api/v1/missingcats/:id`                    | Yes        | update an existing cat          | the updated cat        |
| GET    | `/api/v1/sightedcats`                       | No         | gets a list of sighted cats     | an array of cats       |
| GET    | `/api/v1/sightedcats/singlecat/:id`         | No         | gets an individual sighted cat  | an object              |
| GET    | `/api/v1/sightedcats/singlecat/sighting/:id` | No         | gets all sightings for an individual missing cat   | an object              |
| POST   | `/api/v1/sightedcats/addcat`                 | Yes        | add a new sighted cat           | the newly uploaded cat |
| PATCH  | `/api/v1/sightedcats/:id`                    | Yes        | update a sighted cat            | the updated cat        |
